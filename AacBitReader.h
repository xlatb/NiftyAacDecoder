...
public:
  ...
  unsigned int readBit(void) { if (isComplete()) return 0; uint8_t byte = m_bytes[m_position]; unsigned int v = (byte >> (7 - m_bit)) & 0x01; if (++m_bit > 7) { m_bit = 0; m_position++; }; return v; };
